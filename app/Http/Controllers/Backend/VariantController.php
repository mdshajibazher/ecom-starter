...
class VariantController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('backend.products.variant.index', compact('variants'));
    }
    ...
    {
        return view('backend.products.variant.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('backend.products.variant.edit', compact('product_variant'));
    }
