					...
					<div class="row col-mb-50">
						<div class="col-md-8">
							...
							<div class="widget clearfix">
								...
								<img src="{{asset('frontend/images/footer-widget-logo.png')}}" alt="Footer Logo" class="alignleft" style="margin-top: 8px; padding-right: 18px; border-right: 1px solid #DDD;">
